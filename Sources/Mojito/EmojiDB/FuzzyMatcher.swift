...
struct FuzzyMatcher {
    ...
    private static let pinnedRows: [String: PinnedRow] = [
        ...
        confettiHexcode:      PinnedRow(hexcode: confettiHexcode,      character: "🎊", label: EggStrings.confettiLabel, order: 97),
        prideHexcode:         PinnedRow(hexcode: prideHexcode,         character: "🏳️‍🌈", label: EggStrings.prideLabel,    order: 96),
